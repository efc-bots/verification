            ...
            <div class="col-sm-5 mr-auto">
                <ul class="list-inline social social-sm">
                    <li class="list-inline-item">
                        <a href="https://t.me/EFC_CANCEL"><i class="fa fa-telegram"></i></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="http://twitter.com/EFC_Official_"><i class="fa fa-twitter"></i></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="https://www.youtube.com/channel/UCkkp_GP46zS_mOmVb1HyXpA"><i class="fa fa-youtube"></i></a>
                    </li>
                </ul>
            </div>
        <div class="row mt-5">
